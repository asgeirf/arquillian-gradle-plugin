...
class WeldSeEmbeddedContainerDefinition extends ContainerDefinition {

    public WeldSeEmbeddedContainerDefinition() {
        super(ContainerType.EMBEDDED, 'weld-se-embedded', 'weldSeEmbedded', 'Weld SE 1.1 Embedded')
    }
    ...
    public void configure(final Project project) {
        ...
        project.dependencies {
            "${name}Runtime" 'org.jboss.arquillian.container:arquillian-weld-se-embedded-1.1:1.0.0.CR5'
